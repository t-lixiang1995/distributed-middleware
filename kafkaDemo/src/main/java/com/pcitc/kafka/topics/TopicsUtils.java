package com.pcitc.kafka.topics;
...
public class TopicsUtils {
    private static final String BROKER_URL = "127.0.0.1:9092,127.0.0.1:9093";
    ...
    public static void main(String[] args) {
        ...
        //消费者群组存放分区算法：Math.abs(groupId.hashCode()%numOfPartition)
